    ...
    <div className="about" id="about">
      <div className="row">
        <div
          ...
          className="col-md-6 left d-flex"
        >
          <br />
          <div className="intro">
            <h2 style={{top:30}}>About Me</h2>
            <div className="intro-content">
              <p>
                Hello, I am Prashant, A Computer Science Undergrad. My interests are
                Web Development, Data Structures & Algorithms and Coding. Currently
                evolving my coding skills with C, C++ & Python and Looking for opportunities
                to contribute as Software Developer!
              </p>
            </div>
            <img src={line} />
          </div>
        ...
        {/* right section */}
        <div className="col-md-6 right d-flex justify-content-center no-gutters">
          <div className="av">
            <Avatar
          ...
          <h5 class="head">Other Profiles</h5>
          <div
            data-aos="fade-down"
          ...
          >
            <div>
              <a
                href="https://github.com/pandeyprashant0311"
                target="_blank"
                rel="noreferrer"
                height="37px"
                width="37px"
            ...
            <div>
              <a
                href="https://auth.geeksforgeeks.org/user/pandeyprashant0311/practice/"
                target="_blank"
                rel="noreferrer"
                height="37px"
                width="37px"
            ...
            <div>
              <a
                href="https://www.hackerrank.com/ppandey1_be19?hr_r=1"
                target="_blank"
                rel="noreferrer"
                height="37px"
                width="37px"
            ...
            <div>
              <a href="https://www.codechef.com/users/prashant_0311" target="_blank" rel="noreferrer" height="37px" width="37px">
                <svg
                  class="icon"
                  fill="#5B4638"
                  role="img"
            ...
            <div>
              <a href="https://leetcode.com/pandeyprashant0311/" target="_blank" rel="noreferrer" height="37px" width="37px">
                <svg
                  class="icon"
                  fill="#FFA116"
                  role="img"
            ...
            <div>
              <a
                href="mailto:pandeyprashant0311@gmail.com"
                target="_blank"
                rel="noreferrer"
                height="37px"
                width="37px"
      ...
      <svg
        className="custom-shape-divider-bottom-1622639960"
        data-name="Layer 1"
        xmlns="http://www.w3.org/2000/svg"
